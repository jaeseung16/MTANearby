...
extension TransitRealtime_FeedHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}gtfs_realtime_version\0\u{1}incrementality\0\u{1}timestamp\0")
...
extension TransitRealtime_TripUpdate.StopTimeUpdate.ScheduleRelationship: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SCHEDULED\0\u{1}SKIPPED\0\u{1}NO_DATA\0")
}
...
extension TransitRealtime_VehiclePosition.OccupancyStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0EMPTY\0\u{1}MANY_SEATS_AVAILABLE\0\u{1}FEW_SEATS_AVAILABLE\0\u{1}STANDING_ROOM_ONLY\0\u{1}CRUSHED_STANDING_ROOM_ONLY\0\u{1}FULL\0\u{1}NOT_ACCEPTING_PASSENGERS\0")
}
...
extension TransitRealtime_Alert: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}active_period\0\u{4}\u{4}informed_entity\0\u{1}cause\0\u{1}effect\0\u{1}url\0\u{4}\u{2}header_text\0\u{3}description_text\0")
...
extension TransitRealtime_Alert.Effect: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}NO_SERVICE\0\u{1}REDUCED_SERVICE\0\u{1}SIGNIFICANT_DELAYS\0\u{1}DETOUR\0\u{1}ADDITIONAL_SERVICE\0\u{1}MODIFIED_SERVICE\0\u{1}OTHER_EFFECT\0\u{1}UNKNOWN_EFFECT\0\u{1}STOP_MOVED\0")
}
